...
(define (draw-line v1 v2)
  (define (tx x) (* x (- WIDTH 1)))
  (define (ty y) (* (- 1 y) (- HEIGHT 1)))
...
(define arrow-painter
 ...
 ((below arrow-painter (rotate180 arrow-painter)) full-frame)

; gonna save painting above into picture.png file inside project dir
(send bm save-file "picture.png" 'png)
